...
namespace SocietyAgendor.API.Concrete
{
    public class FuncionarioRepository : Base.Base, IFuncionarioRepository
    {
        ...
        public Funcionario CreateFuncionario(Funcionario model)
        {
            ...
            parameters.Add("@Funcionario_DtNascimento", model.FuncionarioDtNascimento, System.Data.DbType.DateTime);
            ...
            parameters.Add("@Funcionario_DtAdmissao", model.FuncionarioDtNascimento, System.Data.DbType.DateTime);
